export default function VerificationIframe({ url, providerName, onClose }) {
  return (
      ...
      <div className="flex items-center justify-between px-5 py-2.5 bg-bg-card border-b border-border shrink-0">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 font-mono">
            <div className="w-[22px] h-[22px] border-2 border-neon rounded-sm flex items-center justify-center text-[11px] text-neon font-bold">
              ZK
            </div>
